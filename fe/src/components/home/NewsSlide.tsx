    ...
    useEffect(() => {
        const fetchNews = async () => {
            try {
                ...
                setError('An error occurred while loading news data');
                console.error(err);
            } finally {
                setLoading(false);
        ...
        return (
            <div className={`flex justify-center items-center h-64 ${isDarkMode ? 'bg-gray-800' : 'bg-gray-50'}`}>
                <div className="flex flex-col items-center">
                    ...
                    <p className={`mt-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>Loading news...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        ...
        >
                    ...
                    >
                        ...
                        {newsList.map((news, index) => (
                            <SwiperSlide key={news._id}>
                                ...
                                >
                                    {/* Card layout - column for mobile, row for desktop */}
            ...
            <style jsx global>{`
                ...
                /* Prevent content truncation on mobile */
                .news-swiper .swiper-slide {
                    height: auto !important;
                    min-height: 420px;
                }
