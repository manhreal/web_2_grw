...
export const ReadingComprehensionForm: React.FC<ReadingComprehensionFormProps> = ({
    editedQuestion,
    idExists,
    handleIdChange,
    ...
    return (
        <div className="space-y-4">
            ...
            {readingPassage && (
                <div>
                    <label className="block text-sm font-medium mb-1">Reading Passage Reference</label>
                    <div className="p-3 bg-gray-50 rounded-md mt-1 max-h-32 overflow-y-auto">
                        {readingPassage}
                    </div>
                </div>
            )}
